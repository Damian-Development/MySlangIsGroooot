var Snake = (function () {
  ...
  var game = {
    ...
    reset: function () {
      ...
      // Randomly place the snake in the grid
      player.x = Math.floor(Math.random() * tileCount);
      player.y = Math.floor(Math.random() * tileCount);
    ...
    loop: function () {
      ...
      function HitWall() {
        game.reset(); // Reset the game with a new starting position
  ...
  return {
    ...
    action: function (act) {
      switch (act) {
        case ActionEnum.up: game.action.up(); break;
        case ActionEnum.down: game.action.down(); break;
        case ActionEnum.left: game.action.left(); break;
        case ActionEnum.right: game.action.right(); break;
      }
    },
